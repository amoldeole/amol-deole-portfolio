...
import { dynamicSkillsService } from '../../../shared/services/skills.service.dynamic';
import { SkillCategory } from '../../../shared/types/skills.model';
...
const Skills: React.FC = () => {
  ...
  if (loading) {
    return (
      <section id="skills" className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 pt-20 pb-2">
