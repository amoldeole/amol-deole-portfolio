...
const Contact: React.FC = () => {
 ...
 const socialLinks: SocialLink[] = [
  ...
  return (
    <section id="contact" className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 pt-20 pb-2">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="pt-8">
              ...
              <SocialLinks
                links={socialLinks}
                className="gap-4 mb-0 justify-start [&>a]:rounded-lg [&>a]:bg-gray-100 dark:[&>a]:bg-gray-800"
              />
            </div>
          </motion.div>
