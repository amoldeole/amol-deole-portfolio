...
const Certificates: React.FC = () => {
  ...
  return (
    <section id="certificates" className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 pt-20 pb-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 flex flex-col h-full w-full">
        <motion.div
        ...
        <div className="flex-1 flex flex-col">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 flex-1">
